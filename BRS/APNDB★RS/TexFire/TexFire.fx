////////////////////////////////////////////////////////////////////////////////////////////////
//
//  TexFire.fx ver0.0.1 ビルボード＋テクスチャアニメの炎エフェクト
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください
...
#define FireColorTexFile   "palette7.png"   // 炎色palletテクスチャファイル名
...
float fireWvFreqFactor = 2.66;  // 炎の左右の揺らぎ周波数
float firePowAmpFactor = 0.24;  // 炎の明るさ揺らぎ振幅
float firePowFreqFactor = 5.0; // 炎の明るさ揺らぎ周波数
float fireTexMoveLimit = 0.01;  // オブジェクト移動に伴う炎の揺らぎ限界値(移動が大きく炎がボードからはみ出る場合はここを小さくする)
