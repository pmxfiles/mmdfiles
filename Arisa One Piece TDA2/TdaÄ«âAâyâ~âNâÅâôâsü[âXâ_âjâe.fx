...
//実定義部
	...
	#define NORMAL_TEX_0 NORMALMAP_TEX_BASE( 0,"nol.png" ,1)
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_0
#endif
#if   MAKE_NORMAL_TEX_COUNT > 1
	#define NORMAL_TEX_1 NORMALMAP_TEX_BASE( 1,"nol1.png" ,1) NORMAL_TEX_0
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_1
#endif
#if MAKE_NORMAL_TEX_COUNT > 2
	#define NORMAL_TEX_2 NORMALMAP_TEX_BASE( 2,"nol2.png" ,1) NORMAL_TEX_1
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_2
#endif
#if MAKE_NORMAL_TEX_COUNT > 3
	#define NORMAL_TEX_3 NORMALMAP_TEX_BASE( 3,"NormalMap3.png" ,1) NORMAL_TEX_2
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_3
#endif
#if MAKE_NORMAL_TEX_COUNT > 4
	#define NORMAL_TEX_4 NORMALMAP_TEX_BASE( 4,"NormalMap4.png" ,1) NORMAL_TEX_3
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_4
#endif
#if MAKE_NORMAL_TEX_COUNT > 5
	#define NORMAL_TEX_5 NORMALMAP_TEX_BASE( 5,"NormalMap5.png" ,1) NORMAL_TEX_4
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_5
#endif
#if MAKE_NORMAL_TEX_COUNT > 6
	#define NORMAL_TEX_6 NORMALMAP_TEX_BASE( 6,"NormalMap6.png" ,1) NORMAL_TEX_5
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_6
#endif
#if MAKE_NORMAL_TEX_COUNT > 7
	#define NORMAL_TEX_7 NORMALMAP_TEX_BASE( 7,"NormalMap7.png" ,1) NORMAL_TEX_6
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_7
#endif
#if MAKE_NORMAL_TEX_COUNT > 8
	#define NORMAL_TEX_8 NORMALMAP_TEX_BASE( 8,"NormalMap8.png" ,1) NORMAL_TEX_7
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_8
#endif
#if MAKE_NORMAL_TEX_COUNT > 9
	#define NORMAL_TEX_9 NORMALMAP_TEX_BASE( 9,"NormalMap9.png" ,1) NORMAL_TEX_8
	#undef MAKE_NORMAL_TEX_LIST
