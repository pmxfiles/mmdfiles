...
#define USE_NORMAL_MAP_MATERIALS0 "6"
...
//実定義部
	...
	#define NORMAL_TEX_0 NORMALMAP_TEX_BASE( 0,"nmap1.bmp" ,1)
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_0
#endif
#if   MAKE_NORMAL_TEX_COUNT > 1
	#define NORMAL_TEX_1 NORMALMAP_TEX_BASE( 1,"nmap2.bmp" ,1) NORMAL_TEX_0
	#undef MAKE_NORMAL_TEX_LIST
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_1
#endif
#if MAKE_NORMAL_TEX_COUNT > 2
	#define NORMAL_TEX_2 NORMALMAP_TEX_BASE( 2,"NormalMap2.png" ,1) NORMAL_TEX_1
	#undef MAKE_NORMAL_TEX_LIST
