...
#define USE_NORMAL_MAP_MATERIALS1 "2-3"
...
//実定義部
	...
	#define NORMAL_TEX_0 NORMALMAP_TEX_BASE( 0,"Hj_suit_n.png" ,1)
	#define MAKE_NORMAL_TEX_LIST NORMAL_TEX_0
#endif
#if   MAKE_NORMAL_TEX_COUNT > 1
	#define NORMAL_TEX_1 NORMALMAP_TEX_BASE( 1,"Hj_mant_n.png" ,1) NORMAL_TEX_0
